...
const HowItWorks = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      {/* Main Content */}
      <main className="relative z-10 max-w-5xl mx-auto px-6 md:px-8 pb-20">
        <div className="text-center mb-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">How RAW.AI Works</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 relative">
          ...
          {steps.map((step, index) => (
            <div 
              key={index} 
              className={`p-8 rounded-3xl border ${step.border} bg-card/30 backdrop-blur-sm hover:bg-card/50 transition-all duration-500 group`}
            >
              <div className={`w-14 h-14 rounded-2xl ${step.bg} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500`}>
