...
const About = () => {
  ...
  const item = {
    ...
    show: { y: 0, opacity: 1, transition: { type: "spring", stiffness: 50, damping: 20 } as const }
  } as const;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden selection:bg-primary/20">
      ...
      {/* Navigation */}
      <nav className="relative z-50 p-4 md:p-10 flex justify-between items-center">
        <button
          onClick={() => navigate('/')}
      ...
      <main className="relative z-10 container mx-auto px-4 md:px-6 pb-24 max-w-6xl">
        <motion.div 
        ...
        >
          ...
          <motion.div variants={item} className="col-span-1 md:col-span-12 mb-8 text-center md:text-left">
            <h1 className="font-display text-4xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6">
          ...
          {/* Profile Card - Large */}
          <motion.div variants={item} className="col-span-1 md:col-span-5 row-span-2 relative group overflow-hidden rounded-[2rem] md:rounded-[2.5rem] border border-border/50 bg-card/30 backdrop-blur-xl h-[400px] md:h-auto">
          ...
          {/* Education Card */}
          <motion.div variants={item} className="col-span-1 md:col-span-4 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-border/50 bg-card/30 backdrop-blur-md flex flex-col justify-between group hover:border-primary/50 transition-colors">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
              <GraduationCap className="w-6 h-6 md:w-7 md:h-7 text-blue-500" />
            </div>
            <div>
              <h3 className="text-[10px] md:text-sm font-bold uppercase tracking-wider text-muted-foreground mb-2">Education</h3>
              <p className="text-lg md:text-xl font-semibold mb-1">Tech Gaming Technology</p>
              <p className="text-blue-500 font-medium">VIT Bhopal University</p>
            </div>
          </motion.div>

          {/* Role Card */}
          <motion.div variants={item} className="col-span-1 md:col-span-3 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-border/50 bg-card/30 backdrop-blur-md flex flex-col justify-between group hover:border-purple-500/50 transition-colors">
             <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-purple-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
              <Code2 className="w-6 h-6 md:w-7 md:h-7 text-purple-500" />
            </div>
            <div>
              <h3 className="text-[10px] md:text-sm font-bold uppercase tracking-wider text-muted-foreground mb-2">Focus</h3>
              <p className="text-lg md:text-xl font-semibold">Full-Stack &amp;</p>
              <p className="text-purple-500 font-medium">Game Development</p>
            </div>
          </motion.div>

          {/* Skills Marquee / Grid */}
          <motion.div variants={item} className="col-span-1 md:col-span-7 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-border/50 bg-card/30 backdrop-blur-md">
          ...
          <motion.div variants={item} className="col-span-1 md:col-span-12 p-10 rounded-[2.5rem] border border-border/50 bg-gradient-to-br from-card/50 to-background backdrop-blur-md relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-10">
              ...
              <div className="flex md:flex-col gap-4 w-full md:w-auto md:min-w-[200px]">
                <div className="flex-1 p-6 rounded-3xl bg-background/50 border border-border/50 backdrop-blur-sm">
                  <div className="text-3xl md:text-4xl font-bold mb-1">3+</div>
                  <div className="text-[10px] md:text-sm text-muted-foreground uppercase tracking-wider font-medium">Years Exp</div>
                </div>
                <div className="flex-1 p-6 rounded-3xl bg-background/50 border border-border/50 backdrop-blur-sm">
                  <div className="text-3xl md:text-4xl font-bold mb-1">50+</div>
                  <div className="text-[10px] md:text-sm text-muted-foreground uppercase tracking-wider font-medium">Projects</div>
                </div>
              </div>
            </div>
          </motion.div>
