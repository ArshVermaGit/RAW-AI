      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground/60 max-w-2xl text-center leading-relaxed font-medium text-balance">
            The new industrial standard for transforming AI content into 
            <span className="text-foreground font-semibold mx-1.5 underline underline-offset-8 decoration-foreground/10">undetectable</span>
            human narratives that bypass every detector on the planet.
          </p>
